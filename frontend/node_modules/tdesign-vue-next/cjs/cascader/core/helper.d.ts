...
export declare const getCascaderValue: (value: CascaderValue, valueType: TdCascaderProps['valueType'], multiple: boolean) => CascaderValue<import("../..").TreeOptionData<string | number>>;
