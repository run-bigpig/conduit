...
var _Dialog = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var renderDialog = function renderDialog() {
      ...
      var headerContent = renderTNodeJSX("header", defaultHeader);
      ...
      return createVNode("div", {
        ...
        "ref": dialogEle
      }, [(headerContent || headerContent === 0 || props2.closeBtn) && createVNode("div", {
        "class": headerClassName,
        "onMousedown": onStopDown
      }, [createVNode("div", {
        "class": "".concat(COMPONENT_NAME.value, "__header-content")
      }, [getIcon(), headerContent]), props2.closeBtn ? createVNode("span", {
